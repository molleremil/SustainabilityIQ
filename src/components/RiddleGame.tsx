...
const isValidSDG = (sdg: number): sdg is keyof typeof sdgInfo => {
 return sdg >= 1 && sdg <= 17;
};
   ...
   <div className="riddle-game p-4 max-w-lg mx-auto flex flex-col justify-center min-h-screen">
     ...
     {generating ? (
       ...
       <div className="bg-white shadow-md rounded-lg p-6 mb-4">
         {selectedSDG && isValidSDG(selectedSDG) && (
           <div className="flex flex-col items-center mb-4">
             ...
             <p className="text-sm text-center font-semibold">
               {sdgInfo[selectedSDG].name}
             </p>
             <p className="text-xs text-center text-gray-600">
               {sdgInfo[selectedSDG].description}
             </p>
           </div>
         )}
               ...
               {relatedSDGs.map(sdg => (
                 <div key={sdg} className="flex flex-col items-center">
                   ...
                   <p className="text-xs text-center">
                     {isValidSDG(sdg) ? sdgInfo[sdg].name : ''}
                   </p>
                 </div>
               ))}
             </div>
